...
<head>
    <meta charset="utf-8">
    <title>Sportski centar - Nov korisnik</title>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <sec:authorize access="hasAuthority('ADMIN')">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/korisnici/nov-korisnik">Dodaj novog korisnika</a>
                </li>
                <li class="nav-item">
    ...
    <form:form action="${contextPath}/korisnici/add" modelAttribute="korisnik" method="post">
