...
<head>
    <meta charset="utf-8">
    <title>Sportski centar - nova usluga</title>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <sec:authorize access="hasAuthority('ADMIN')">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/usluge/nova-usluga">Nova usluga</span></a>
                </li>
            </sec:authorize>
            <li class="nav-item">
    ...
    <div class="container">
    <h2>Nova usluga</h2>
    <form:form action="${contextPath}/usluge/add" modelAttribute="usluga" method="post">
        ...
        <div class="form-group">
          <form:label for="selectVrstuUsluge" path="vrstaUsluge">Vrsta usluge</form:label>
          <form:select class="form-control" id="selectVrstuUsluge" path="vrstaUsluge">
            <form:options items="${svevrsteusluga}" id="id" itemLabel="naziv"></form:options>
          </form:select>
        </div>
        <form:input type="hidden"  path="aktivna"/>
