...
<head>
    <meta charset="utf-8">
    <title>Sportski centar - izmeni uslugu</title>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <sec:authorize access="hasAuthority('ADMIN')">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="/usluge">Usluge</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
    <h2>Izmeni uslugu</h2>
    <form:form action="${contextPath}/usluge/${usluga.id}/update" modelAttribute="usluga" method="post">
